/**
 * Rule Name : ProjRep - Calculate Total Claimed Cost
 * Purpose   : Calculate Total Claimed Cost based on Total Line Item
 * Created   : 03/12/2024
 * Author    : Sneha Singh
 */
...
// ----------------------------
String script = """
([Total Claimed Cost]) := ([Total Line Item]);
"""
...
println("Total Claimed Cost calculation executed successfully.")
