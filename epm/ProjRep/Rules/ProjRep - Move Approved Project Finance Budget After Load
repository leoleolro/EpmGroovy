...
targetGrid.addPov( 'Final', 'FinancePlan', 'Month')
...
}</script></rule></rules><components/><deployobjects><deployobject product="2" application="rpepm" plantype="projrep" obj_id="1" obj_type="1" name="PROJREP - MOVE APPROVED PROJECT FINANCE BUDGET AFTER LOAD"/></deployobjects></HBRRepo>