...
</script></rule></rules><components/><deployobjects><deployobject product="2" application="rpepm" plantype="projrep" obj_id="1" obj_type="1" name="PROJREP -INITIAL SETUP USER VARIABLE"/><deployobject product="2" application="rpepm" obj_id="1" obj_type="2" name="SET USER PREFERENCES"/></deployobjects></HBRRepo>