...
if(ProjList.size()==0){
 ...
 println "Rule : ProjRep - Clear Project_Actuals | No Projects are Active. Exiting script. |Total Time Elapsed : ${(currentTimeMillis() - startTime) / 1000} Secs."
...
</script></rule></rules><components/><deployobjects><deployobject product="2" application="rpepm" plantype="projrep" obj_id="1" obj_type="1" name="PROJREP - CLEAR PROJECT_ACTUALS"/></deployobjects></HBRRepo>